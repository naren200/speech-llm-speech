...
if __name__ == '__main__':
    ...
    print()
    print('    flask --app /root/ros2_ws/src/speech-llm-speech/whisper_asr/ros_process_control.py run --host=0.0.0.0 --port=5050')
    print()
    exit(1)
...
app = Flask(__name__)
CORS(app)
path = '/root/ros2_ws/src/speech-llm-speech/whisper_asr/launch/'
file = os.getenv('LAUNCH_FILE', 'whisper_asr_launch.py')
